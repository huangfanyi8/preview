...
int main()
{
  ...
  preview::ranges::swap(a1, a2);
  print("a", a1, a2);
  
  std::array b1{15, 16, 17}, b2{18, 19, 20};
  preview::ranges::swap(b1, b2);
  print("b", b1, b2);
  ...
  IntLike g1[]{1, 2, 3};
  int     g2[]{4, 5, 6};
  preview::ranges::swap(g1, g2); // heterogeneous swap supported
  print("g", g1, g2);
  
  int h1{27}, h2{28};
  preview::ranges::swap(h1, h2);
  print("h", h1, h2);
}
